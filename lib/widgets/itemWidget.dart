...
import 'package:delossantos/models/catalog.dart';
      ...
      child: Card(
        ...
        child: Padding(
          ...
          child: ListTile(
            ...
            title: Padding(
              padding: const EdgeInsets.all(8.0),
              child: Center(child: Text(item.name, style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 20))),
            ),
